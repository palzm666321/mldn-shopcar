						...
						<form class="form-horizontal" action="<%=ORDERS_ADD_URL%>" id="myform" method="post">
											...
											<c:forEach items="${allGoods}" var="goods">
												<tr>
													...
													<td class="text-center">
														￥${goods.price} × ${allShopcars[goods.gid]} = 
														<span id="allprice-${goods.gid}" class="text-danger">${goods.price * allShopcars[goods.gid]}</span></td>
												</tr>
											</c:forEach>
										</tbody> 
									</table>
							...
							<div class="form-group">
								<div class="col-md-5 col-md-offset-3">
									<input type="hidden" name="gids" id="gids" value="${param.gids}">
